...
function EventCard({ event }: { event: Event }) {
  ...
  return (
    <div className={`bg-white rounded-lg shadow-md border-l-4 ${
      isConfirmed ? 'border-l-[#003300]' : 'border-l-[#99CCCC]'
      ...
      <div className="flex items-start justify-between mb-4">
        ...
        <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${
          isConfirmed 
            ? 'bg-[#003300]/10 text-[#003300]' 
            : 'bg-[#99CCCC]/20 text-[#003300]'
        }`}>
      ...
      <div className="mb-4">
        <div className="flex items-center text-gray-700 mb-2">
          <svg className="w-5 h-5 mr-2 text-[#99CCCC]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {event.additionalInfo && (
        <div className="mb-4 p-3 bg-[#99CCCC]/10 rounded-md">
          <p className="text-[#003300] text-sm font-medium">
            📍 {event.additionalInfo}
          </p>
        </div>
      )}
      ...
      <div className="flex flex-wrap gap-3">
        {event.signUpLink && (
          <a
            ...
            className="inline-flex items-center px-4 py-2 bg-[#99CCCC] text-[#003300] text-sm font-medium rounded-md hover:bg-[#99CCCC]/80 transition-colors"
          >
        ...
        {event.flyerLink && (
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center px-4 py-2 bg-[#003300] text-white text-sm font-medium rounded-md hover:bg-[#003300]/80 transition-colors"
          >
            <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <main className="min-h-screen bg-gray-50">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-[#003300] mb-4">Upcoming Events</h1>
        ...
        <div className="mb-8 p-4 bg-white rounded-lg shadow-sm border">
          <h3 className="text-sm font-medium text-[#003300] mb-2">Event Status:</h3>
          <div className="flex flex-wrap gap-4 text-sm">
            <div className="flex items-center">
              <div className="w-3 h-3 bg-[#003300] rounded-full mr-2"></div>
              <span className="text-gray-600">Confirmed - Ready for sign-up</span>
            </div>
            <div className="flex items-center">
              <div className="w-3 h-3 bg-[#99CCCC] rounded-full mr-2"></div>
        ...
        <div className="mt-12 text-center p-6 bg-white rounded-lg shadow-sm border">
          ...
          <Link
            href="/get-involved"
            className="inline-flex items-center px-6 py-3 bg-[#99CCCC] text-[#003300] font-medium rounded-md hover:bg-[#99CCCC]/80 transition-colors"
          >
            Get Involved
