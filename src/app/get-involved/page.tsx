    ...
    <main className="min-h-screen bg-white py-16 px-4">
      <div className="max-w-3xl mx-auto space-y-16 text-gray-700 text-lg">
        <header className="text-center">
          <h1 className="text-4xl font-bold text-client-green mb-4">Get Involved</h1>
        ...
        <section className="bg-white border border-gray-200 p-8 rounded-lg shadow-sm text-center">
          <h2 className="text-2xl font-semibold text-client-green mb-2">Join Our Email List</h2>
          <p className="mb-6">
        ...
        {/* Donate Section */}
        <section className="bg-white border border-gray-200 p-8 rounded-lg shadow-sm text-center">
          <h2 className="text-2xl font-semibold text-client-green mb-2">Donate to Support Our Work</h2>
          <p className="mb-6">
