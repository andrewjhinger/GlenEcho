        ...
        <main className="min-h-screen">
            ...
            <section className="py-16 px-4 bg-white">
                <div className="max-w-4xl mx-auto space-y-6 text-gray-700 text-lg">
                    <h1 className="text-4xl font-bold text-client-green">Glen Echo: A Historic Columbus Neighborhood</h1>
                    ...
                    <h2 className="text-2xl font-bold text-client-green">A Planned Community with Purpose</h2>
                    ...
                    <h2 className="text-2xl font-bold text-client-green">Streets That Follow Nature</h2>
                    ...
                    <h2 className="text-2xl font-bold text-client-green">Glen Echo Park and Ravine</h2>
                    ...
                    <h2 className="text-2xl font-bold text-client-green">A Rich Architectural Legacy</h2>
                    ...
                    <h2 className="text-2xl font-bold text-client-green">A Community Built to Last</h2>
            ...
            <section className="py-16 px-4 bg-gray-50">
                <div className="max-w-4xl mx-auto text-gray-700 text-lg space-y-4">
                    <h2 className="text-2xl font-semibold mb-4 text-client-green">Historical Images & Maps</h2>
                    <a
